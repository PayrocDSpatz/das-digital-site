...
const Card = ({ icon, title, children }: { icon: React.ReactNode; title: string; children: React.ReactNode }) => (
  <div className="rounded-3xl border-2 border-purple-500 bg-white/5 p-6 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.7)] backdrop-blur">
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#070910]/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-purple-500/30 hover:from-purple-500 hover:to-fuchsia-500"
          >
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <h1 className="mt-5 text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                Build an <span className="text-white">Automation + AI Engine</span> that runs your workflows and turns
                follow-ups into revenue.
              </h1>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <a
                  href={brand.primaryCta.href}
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-purple-600 to-fuchsia-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-500/30 hover:from-purple-500 hover:to-fuchsia-500"
                >
                  {brand.primaryCta.label} <ArrowRight className="h-4 w-4" />
                </a>
                <a
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-3xl border border-white/10 bg-black/20 p-4">
                    ...
                    <div className="mt-3 flex h-10 items-end gap-1">
                      <div className="w-3 rounded bg-purple-400/70" style={{ height: "40%" }} />
                      <div className="w-3 rounded bg-purple-400/70" style={{ height: "65%" }} />
                      <div className="w-3 rounded bg-purple-400/70" style={{ height: "55%" }} />
                      <div className="w-3 rounded bg-purple-400/70" style={{ height: "80%" }} />
                      <div className="w-3 rounded bg-purple-400/70" style={{ height: "60%" }} />
                    </div>
                  </div>
                  <div className="rounded-3xl border border-white/10 bg-black/20 p-4">
                    <div className="flex items-center gap-2 text-xs text-white/60">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border-2 border-purple-500 bg-gradient-to-b from-white/10 to-white/5 p-6 shadow-[0_0_0_1px_rgba(168,85,247,0.25),0_20px_40px_-25px_rgba(168,85,247,0.45)]">
              ...
              <ul className="mt-4 space-y-3 text-sm text-white/80">
                {[
                  "We embed with your team and execute",
                  "Automate end-to-end (capture → approvals → updates → notifications)",
                  "AI-assisted follow-ups with human checks",
                  "Documentation + handoff so you own the playbook"
                ].map((t) => (
                  <li key={t} className="flex items-start gap-2">
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6" id="proof">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {[
              ...
              <div
                key={x.before}
                className="rounded-3xl border-2 border-purple-500 bg-white/5 p-6 shadow-[0_0_0_1px_rgba(168,85,247,0.25),0_20px_40px_-25px_rgba(168,85,247,0.45)]"
              >
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mt-3 text-white/70">
                  Tell us what you’re trying to automate (or what’s breaking). We’ll respond with a clear blueprint: tools,
                  steps, timeline, and rough ROI.
                </p>
                <ul className="mt-5 space-y-2 text-sm text-white/75">
                  {["No fluff. Clear next actions.", "Includes quick wins + longer-term build.", "Guardrails + security considerations."].map(
                    (t) => (
                      <li key={t} className="flex items-start gap-2">
                        <span className="mt-0.5 grid h-5 w-5 place-items-center rounded-full bg-white text-black">
                          <Check className="h-3 w-3" />
          ...
          <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
            <div className="grid gap-6 md:grid-cols-2 md:items-center">
              ...
              <div className="md:text-right">
                <a
                  href={brand.primaryCta.href}
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-fuchsia-600 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-purple-500/30 hover:from-purple-500 hover:to-fuchsia-500"
                >
                  {brand.primaryCta.label} <ArrowRight className="h-4 w-4" />
                </a>
